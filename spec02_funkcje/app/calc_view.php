...
<body>
    ...
    <?php
        ...
        if ($role != 'admin') {
            ...
            <strong>Uwaga! <br></strong>Z rolą \'user\' nie możesz przeliczyć kredytu powyżej 100 000 PLN.</ul></div>';
        }
    ?>
            <label for="id_kwota">Kwota kredytu: </label>
            <input id="id_kwota" min="1000" step="1000" max="250000" type="range" name="kwota" autocomplete="off" value="<?php out($kwota); ?>">
            <font id="kwotaTekst"><?php out($kwota); ?></font> <font id="dopisekMSC2"> <?php echo isset($kwota) ? 'MSC' : ""; ?></font><br>
            ...
            <script>
                ...
                kwota.oninput = function() {
                    ...
                    document.getElementById("dopisekMSC2").innerHTML = "MSC";
                }
